...
const CMS = (() => {
  ...
  const DEFAULTS = {
    ...
    content: {
      ...
      hero_sub2:     'Onze Smiling Barista\'s zitten nooit stil! Zij trappen om jullie koffie te tappen!',
      ...
      about_text2:   'Onze Smiling Barista\'s zitten nooit stil! Zij trappen om jullie koffie te tappen!',
      about_offer_text: 'Vertel ons over jullie event en ontvang een voorstel!',
      about_image:   '',
